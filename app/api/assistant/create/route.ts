...
export async function GET() {
  ...
  try {
    const assistant = await openai.beta.assistants.create({
      ...
      I will ask you for the current price of a stock, and you will tell me the price of only that particular stock and provide me a link to the logo of the company.
        `,
